---
title: HTML
description: "Appunti di HTML"
permalink: /wiki/linguaggi/html/
categories: [linguaggi]
image: https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/HTML5_logo_and_wordmark.svg/1280px-HTML5_logo_and_wordmark.svg.png?utm_source=it.wikipedia.org&utm_campaign=index&utm_content=thumbnail
---
...
3. [Struttura minima di una pagina]
  1. [<!DOCTYPE html>]
  2. [Tag <html>]
  3. [Tag <head>]
  4. [Tag <body>]
...
13. [Metadata e <head>]
14. [HTML e DOM]
15. [Validazione e debugging]
16. [HTML obsoleto]

## Cos'è HTML

HTML (HyperText Markup Language) è un linguaggio di markup utilizzato per creare pagine web. Consente di strutturare il contenuto e definire la presentazione dei documenti attraverso l'uso di tag e attributi. HTML è fondamentale per il web, poiché fornisce la base su cui si costruiscono siti e applicazioni web, permettendo l'integrazione di testo, immagini, video, link e altri elementi multimediali.
...
Il tag `<html>` è l'elemento radice di un documento HTML. Tutti gli altri elementi devono essere contenuti all'interno di questo tag. L'attributo `lang` può essere utilizzato per specificare la lingua del contenuto della pagina.

### Tag <head>

Il tag `<head>` contiene informazioni meta del documento, come il titolo, i metadati e i link a risorse esterne.
